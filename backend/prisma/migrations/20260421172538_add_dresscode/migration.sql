...
INSERT INTO "new_Invitation" ("brideName", "colorScheme", "coverPhoto", "createdAt", "galleryPhotos", "groomName", "id", "inviteText", "mapLink", "musicUrl", "paidAt", "paymentId", "plan", "slug", "status", "story", "templateId", "title", "updatedAt", "userId", "venue", "venueAddress", "weddingDate", "weddingTime") SELECT "brideName", "colorScheme", "coverPhoto", "createdAt", "galleryPhotos", "groomName", "id", "inviteText", "mapLink", "musicUrl", "paidAt", "paymentId", "plan", "slug", "status", "story", "templateId", "title", "updatedAt", "userId", "venue", "venueAddress", "weddingDate", "weddingTime" FROM "Invitation";
