...
export const LEGAL = {
  ...
  sellerStatusGenitive: 'самозанятого (плательщика налога на профессиональный доход)',
...
export const PLANS = [
  ...
  },
  {
    ...
    price: 5990,
    period: 'разовая оплата за один сайт',
    features: ['Всё из Базового', 'Личный кабинет гостей', 'Персональные ссылки с именным обращением', 'Ответы по каждому гостю', 'Свой домен', 'Неограниченно гостей и фото'],
    color: '#c9a96e',
    popular: true,
  },
];
