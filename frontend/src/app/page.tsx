    ...
    <section id="pricing" className={styles.pricingSection}>
      <div className={styles.sectionInner}>
        ...
        <p className={styles.pricingNote} data-animate>
          Домен не входит в тариф: вы покупаете его сами у любого регистратора, а мы
          помогаем привязать его к сайту — в личном кабинете есть пошаговая инструкция.
          Без своего домена сайт работает по ссылке на нашем.
        </p>
      </div>
    </section>
  );
...
function CompareSection() {
  ...
  const site = [
    '2 490 ₽ один раз — на всех гостей сразу',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Оплата разовая: 2 490 ₽ — тариф «Премиум», в нём всё: анкета для гостей, уведомления об ответах, музыка, карта, личный кабинет гостей и свой домен. Никаких подписок и продлений — опубликованный сайт работает бессрочно, а правки бесплатны и в любой момент.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да, в тарифе «Премиум». Сам домен вида ivan-i-anna.ru вы покупаете у регистратора — reg.ru, Timeweb или любого другого, мы домены не продаём. Дальше в личном кабинете есть пошаговая инструкция: прописать две DNS-записи и нажать «Проверить подключение». Без своего домена сайт открывается по ссылке на нашем.',
  },
];
